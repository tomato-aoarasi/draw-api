...
public:
    ...
    public:
        ...
        const inline static json getJsonResult(status state, std::string_view msg = "", uint16_t status_code = 1) {
        ...
        const inline static json getSimpleJsonResult(int code, std::string_view msg = "", uint16_t status_code = 1) {
