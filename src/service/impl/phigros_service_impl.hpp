...
public:
	...
	inline cv::Mat drawPlayerSingleInfoModernStyle(std::string_view song_id, Ubyte level,
		...
		freetype2->loadFontData("draw/phi/font/AdobeStdR.otf", 0);
		freetype2->putText(result, "Powerd by yuhao7370. Generated by tomato Team - Phigros.", cv::Point(18, size_h - 30) + cv::Point(3, 4), 24, cv::Scalar(5, 5, 5), -1, cv::LINE_AA, false);
		freetype2->putText(result, "Powerd by yuhao7370. Generated by tomato Team - Phigros.", cv::Point(18, size_h - 30), 24, cv::Scalar(255, 255, 255), -1, cv::LINE_AA, false);
		freetype2.release();
